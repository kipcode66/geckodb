...
def main(argv=sys.argv):
    name_pattern = re.compile(r"[a-zA-Z_][a-zA-Z0-9_]*", re.I)
    ...
    file_type_group.add_argument("--cpp-file", help="Generate a C++ source file instead of a header file.", action="store_true")
    file_type_group.add_argument("--c-file", help="Generate a C source file instead of a header file.", action="store_true")
    parser.add_argument("-g", "--guard", help="Customize the name of the Header Guard.", type=var_name_type)
